(ns ovenfurnacemfg.registry-test
  (:require [clojure.test :refer [deftest is]]
            [ovenfurnacemfg.registry :as r]))
...
(deftest known-product-types-are-valid
  (doseq [pt [:industrial-oven :heat-treatment-furnace :melting-furnace :furnace-burner]]
...
;; ----------------------------- thermal-test-degc-valid? -----------------------------

(deftest typical-thermal-test-degc-is-valid
  (is (r/thermal-test-degc-valid? 0.0))
  (is (r/thermal-test-degc-valid? 600.0))
  (is (r/thermal-test-degc-valid? 1150.0))
  (is (r/thermal-test-degc-valid? 3000.0)))

(deftest negative-thermal-test-degc-is-invalid
  (is (not (r/thermal-test-degc-valid? -1.0))))

(deftest excessive-thermal-test-degc-is-invalid
  (is (not (r/thermal-test-degc-valid? 999999.0)))
  (is (not (r/thermal-test-degc-valid? 3000.01))))

(deftest non-numeric-or-missing-thermal-test-degc-is-invalid
  (is (not (r/thermal-test-degc-valid? nil)))
  (is (not (r/thermal-test-degc-valid? "850.0"))))
