...
`cloud-itonami-isic-2815` is an OSS open-business blueprint for
oven/furnace/furnace-burner plant operations coordination.

## Maintainers
Maintainers may merge changes that preserve these invariants:
- a fabrication/assembly-line-equipment action the governor refuses is never dispatched to hardware.
- the Oven & Furnace Plant Operations Governor remains independent of the advisor.
