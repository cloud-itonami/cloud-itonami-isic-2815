# Business Model: Manufacture of ovens, furnaces and furnace burners
...
## Classification
- Repository: `cloud-itonami-isic-2815` ([github.com/cloud-itonami/cloud-itonami-isic-2815](https://github.com/cloud-itonami/cloud-itonami-isic-2815))
- ISIC Rev.5: `2815` — Manufacture of ovens, furnaces and furnace burners
- Domain: `:oven-furnace/manufacturing`
- Social impact: :worker-safety :combustion-safety :thermal-hazard-safety :equipment-safety
- Actor: `:oven-furnace-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :oven-furnace/manufacturing — who wants
...
One managed tenant (:oven-furnace/manufacturing):
...
- Do not bypass the `:oven-furnace-plant-operations-governor` for production decisions.
