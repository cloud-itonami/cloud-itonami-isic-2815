# Operator Quickstart — Manufacture of ovens, furnaces and furnace burners

Shortest path from clone to a verified local dry-run for **ISIC 2815** (`cloud-itonami-isic-2815`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2815.git
cd cloud-itonami-isic-2815
```
...
- Blueprint governor key: `oven-furnace-plant-operations-governor`
- Likely source path: `ovenfurnacemfg.governor.cljc`
