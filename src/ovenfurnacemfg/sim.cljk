(ns ovenfurnacemfg.sim
  ...
  a proposal that tries to self-issue a UL/CSA/CE combustion-equipment
  ...
  an implausible thermal-test-degc reading, and a production-batch
...
(defn -main [& _args]
  (let [db (-> (store/mem-store) (store/sample-data!))
    ...
    (println "== schedule-maintenance mnt-2 on bench-002 (UNVERIFIED/unregistered thermal-test bench -> HARD hold) ==")
    ...
    (println "== log-production-batch batch-001 with an implausible thermal-test-degc -> HARD hold ==")
    ...
    (println "== log-production-batch batch-001 attempting to self-issue a combustion-equipment safety certification -> HARD hold, PERMANENT ==")
