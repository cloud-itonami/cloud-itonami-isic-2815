(ns ovenfurnacemfg.phase
  "Phase 0->3 staged rollout for the industrial oven/furnace/furnace-
  burner (industrial ovens, heat-treatment furnaces, melting furnaces,
  furnace burners) plant-operations coordination actor.
  ...
  consequence (a fabrication/assembly/thermal-test-bench-equipment
  ...
  `ovenfurnacemfg.governor`'s `equipment-actuate-blocked-violations`
...
(defn verdict->disposition
  "Map an Oven & Furnace Plant Operations Governor verdict to a base
